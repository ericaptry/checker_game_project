			<section>
				<h1>Pieces have the following properties:</h1>
				<ol class="quotedrules">
					<li>Regular Pieces</li>
					<ol>
						<li>Each player starts with 12 <b>regular pieces</b> on each of the black squares of the first three rows on their side.</li>
						<li>One player's <b>regular pieces</b> are black. The other player's <b>regular pieces</b> are red.</li>
					</ol>
					<li>Kings</li>
					<ol>
						<li>No players start with <b>kings</b>.</li>
						<li>The color of <b>kings</b> are the same as <b>regular pieces</b>, but they generally look bigger or fancier.</li>
						<li>Placing a <b>regular piece</b> on the opposing player's first row turns it into a <b>king</b>.</li>
					</ol>
				</ol>
				<h1>How to Play!</h1>
				<ol>
